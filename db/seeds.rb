...
# 	Stat.create(:name => "jump shots made", :skill_id => 5)	
# 	Stat.create(:name => "jump shots attempted", :skill_id => 5)
# 	Stat.create(:name => "lay ups  attempted", :skill_id => 5)
# 	Stat.create(:name => "lay ups made", :skill_id => 5)


# 	Skill.create(:name => "illegal plays", :level_of_difficulty => 8)	
# 	Stat.create(:name => "turnovers", :skill_id => 6)	
# 	Stat.create(:name => "reach in's made", :skill_id => 6)
# 	Stat.create(:name => "hand checks made", :skill_id => 6)
# 	Stat.create(:name => "blocking foul made", :skill_id => 6)	

# 	Stat.create(:name => "stealing the ball", :skill_id => 1)  
# 	Stat.create(:name => "assists", :skill_id => 7) 
# 	Stat.create(:name => "charges made", :skill_id => 7) 
	
	Skill.create(:name => "heroic", :level_of_difficulty => 10)
	Stat.find_by_name("stealing the ball").update_attributes(:skill_id => 8)
	Stat.find_by_name("assists").update_attributes(:skill_id => 8)
	Stat.find_by_name("charges made").update_attributes(:skill_id => 8)
